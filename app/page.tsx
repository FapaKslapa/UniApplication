...
export default function Home() {
  const { data: orario, isLoading, error } = api.orario.getOrario.useQuery({ name: "test" });
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 font-mono text-sm">Caricamento orario...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-red-400 font-mono text-sm mb-2">Errore nel caricamento</p>
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-md mx-auto px-4 py-6 space-y-6">
        {/* Sezione Prossima Lezione */}
        <section>
          <h2 className="text-lg font-semibold mb-4 text-white">Prossima Lezione</h2>
          <NextLessonCard />
        </section>

        {/* Vista Calendario */}
        <section>
          <h2 className="text-lg font-semibold mb-4 text-white">Orario Settimanale</h2>
